...
export default function TrackingPage({ params }: TrackingPageProps) {
  ...
  const handleTrack = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Booking not found. Please check your tracking code.');
      setBookingData(null);
    } finally {
      setLoading(false);
    }
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Enter your tracking code to view real-time updates and location of your package
            </p>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">
                      Tracking: {bookingData.trackingCode}
                    </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <p className="text-xs font-medium text-green-600 uppercase mb-2">Origin</p>
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Pickup: {new Date(bookingData.pickupDate).toLocaleString()}
                    </p>
                  </div>

                  {/* Destination */}
                  <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                    <p className="text-xs font-medium text-red-600 uppercase mb-2">Destination</p>
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Est. Delivery: {new Date(bookingData.estimatedDeliveryDate).toLocaleString()}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{bookingData.packageDetails.type}</p>
                    </div>
                    <div>
                      <p className="text-gray-600">Weight</p>
                      <p className="font-medium">{bookingData.packageDetails.weight} kg</p>
                    </div>
                    <div>
                      <p className="text-gray-600">Dimensions</p>
                      <p className="font-medium">{bookingData.packageDetails.dimensions}</p>
                    </div>
                    <div>
                      <p className="text-gray-600">Value</p>
                      <p className="font-medium">€{bookingData.packageDetails.value}</p>
                    </div>
                  </div>
                </div>
              </div>
